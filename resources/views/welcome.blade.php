...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <!-- animation css files -->
    <link rel="stylesheet" href="{{ asset('web/css/animation-aos.css') }}">
    <link href="{{ asset('web/css/animation-aos.css') }}" rel='stylesheet prefetch' type="text/css" media="all" />
    <!-- //animation css files -->
    ...
    <div class="container py-lg-3">
        ...
        <div class="row test-grids">
            <div class="col-md-4 col-sm-7 col-9" data-aos="zoom-in">
                <img src="{{asset('web/images/b3.png')}}" alt="" class="img-fluid" />
            </div>
            <div class="col-md-8">
...
<div class="cpy-right text-center py-3">
    <p class="">© 2018 Landing. All rights reserved | Design by
